...
plot(yplus,Reynolds_uu_k)
hold on;
plot(yplus,Reynolds_vv_k)
hold on;
plot(yplus,Reynolds_ww_k)
hold on;
plot(yplus,Reynolds_uv_k)
hold on;
plot(yplus,Reynolds_uw_k)
hold on;
plot(yplus,Reynolds_vw_k)
hold on;

legend('uu/k','vv/k','ww/k','uv/k','uw/k','vw/k')
xlabel('y+')
ylabel('<u(i)u(j)>/k')
