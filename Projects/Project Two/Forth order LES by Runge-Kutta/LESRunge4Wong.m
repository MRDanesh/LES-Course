...
outpath = ['.',filesep,'LESWong_',int2str(Nx),filesep];
[~,~,~] = mkdir(outpath);

file_u  = fopen([outpath,'Wong_',int2str(Nx),'_U.out'],'w');
...
for s = 1:NSteps
    ...
    %%% LES Modeling %%%%
         ...
         N11_1(1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx,u,h,Nx)),(grad4_u(1,u,h,Nx)),(grad4_u(2,u,h,Nx)))*(2^(4/3)-1);
        ...
        L11_1(1)=filter_Boundary(u(Nx,1)*u(Nx,1),u(1,1)*u(1,1),u(2,1)*u(2,1))-...
            filter_Boundary(u(Nx,1),u(1,1),u(2,1))*filter_Boundary(u(Nx,1),u(1,1),u(2,1));
                ...
                N11_1(2)=-2*(h^(4/3))*filter_Boundary((grad4_u(1,u,h,Nx)),(grad4_u(2,u,h,Nx)),(grad4_u(3,u,h,Nx)))*(2^(4/3)-1);
    ...
    L11_1(2)=filter_Boundary(u(1,1)*u(1,1),u(2,1)*u(2,1),u(3,1)*u(3,1))-...
         ...
         N11_1(Nx-1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-2,u,h,Nx)),(grad4_u(Nx-1,u,h,Nx)),(grad4_u(Nx,u,h,Nx)))*(2^(4/3)-1);
         ...
         L11_1(Nx-1)=filter_Boundary(u(Nx-2,1)*u(Nx-2,1),u(Nx-1,1)*u(Nx-1,1),u(Nx,1)*u(Nx,1))-...
            ...
            N11_1(Nx)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-1,u,h,Nx)),(grad4_u(Nx,u,h,Nx)),(grad4_u(1,u,h,Nx)))*(2^(4/3)-1);
    ...
    for j=3:Nx-2
        N11_1(j)=-2*(h^(4/3))*filter_Boundary((grad4_u(j-1,u,h,Nx)),(grad4_u(j,u,h,Nx)),(grad4_u(j+1,u,h,Nx)))*(2^(4/3)-1);
    ...
    dd=0;
    for j=1:Nx
        pp=pp+L11_1(j)*N11_1(j);
        dd=dd+N11_1(j)*N11_1(j);
    end
Cw_1(s)=pp/dd; 
    Cw_1(1)=0;
    
    for j=3:Nx-2
    tau_1(j)=-2*Cw_1(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    
    for j=1
    tau_1(j)=-2*Cw_1(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1+Nx,1) +u(j-2+Nx,1) )/(12*h);   
    end
 
     for j=2
    tau_1(j)=-2*Cw_1(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2+Nx,1) )/(12*h);
     end
    
     for j=Nx-1
    tau_1(j)=-2*Cw_1(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
     
     for j=Nx
    tau_1(j)=-2*Cw_1(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1-Nx,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
...
N11_2(1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx,u2,h,Nx)),(grad4_u(1,u2,h,Nx)),(grad4_u(2,u2,h,Nx)))*(2^(4/3)-1);
        ...
        L11_2(1)=filter_Boundary(u2(Nx,1)*u2(Nx,1),u2(1,1)*u2(1,1),u2(2,1)*u2(2,1))-...
            filter_Boundary(u2(Nx,1),u2(1,1),u2(2,1))*filter_Boundary(u2(Nx,1),u2(1,1),u2(2,1));
                ...
                N11_2(2)=-2*(h^(4/3))*filter_Boundary((grad4_u(1,u2,h,Nx)),(grad4_u(2,u2,h,Nx)),(grad4_u(3,u2,h,Nx)))*(2^(4/3)-1);
    ...
    L11_2(2)=filter_Boundary(u2(1,1)*u2(1,1),u2(2,1)*u2(2,1),u2(3,1)*u2(3,1))-...
         ...
         N11_2(Nx-1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-2,u2,h,Nx)),(grad4_u(Nx-1,u2,h,Nx)),(grad4_u(Nx,u2,h,Nx)))*(2^(4/3)-1);
         ...
         L11_2(Nx-1)=filter_Boundary(u2(Nx-2,1)*u2(Nx-2,1),u2(Nx-1,1)*u2(Nx-1,1),u2(Nx,1)*u2(Nx,1))-...
            ...
            N11_2(Nx)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-1,u2,h,Nx)),(grad4_u(Nx,u2,h,Nx)),(grad4_u(1,u2,h,Nx)))*(2^(4/3)-1);
    ...
    for j=3:Nx-2
        N11_2(j)=-2*(h^(4/3))*filter_Boundary((grad4_u(j-1,u2,h,Nx)),(grad4_u(j,u2,h,Nx)),(grad4_u(j+1,u2,h,Nx)))*(2^(4/3)-1);
    ...
    dd=0;
    for j=1:Nx
        pp=pp+L11_2(j)*N11_2(j);
        dd=dd+N11_2(j)*N11_2(j);
    end
    Cw_2(s)=pp/dd; 
    Cw_2(1)=0;
    
    for j=3:Nx-2
    tau_2(j)=-2*Cw_2(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    
    for j=1
    tau_2(j)=-2*Cw_2(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1+Nx,1) +u(j-2+Nx,1) )/(12*h);   
    end
 
     for j=2
    tau_2(j)=-2*Cw_2(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2+Nx,1) )/(12*h);
     end
    
     for j=Nx-1
    tau_2(j)=-2*Cw_2(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
     
     for j=Nx
    tau_2(j)=-2*Cw_2(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1-Nx,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    ...
    for j=2
        ...
        RSG_2(j,1)=0.5* ( -tau_2(j+2)+ 8*tau_2(j+1)-8*tau_2(j-1)+ tau_2(j-2+Nx) )/(12*h);
    end
    ...
    N11_3(1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx,u3,h,Nx)),(grad4_u(1,u3,h,Nx)),(grad4_u(2,u3,h,Nx)))*(2^(4/3)-1);
        ...
        L11_3(1)=filter_Boundary(u3(Nx,1)*u3(Nx,1),u3(1,1)*u3(1,1),u3(2,1)*u3(2,1))-...
            filter_Boundary(u3(Nx,1),u3(1,1),u3(2,1))*filter_Boundary(u3(Nx,1),u3(1,1),u3(2,1));
                ...
                N11_3(2)=-2*(h^(4/3))*filter_Boundary((grad4_u(1,u3,h,Nx)),(grad4_u(2,u3,h,Nx)),(grad4_u(3,u3,h,Nx)))*(2^(4/3)-1);
    ...
    L11_3(2)=filter_Boundary(u3(1,1)*u3(1,1),u3(2,1)*u3(2,1),u3(3,1)*u3(3,1))-...
         ...
         N11_3(Nx-1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-2,u3,h,Nx)),(grad4_u(Nx-1,u3,h,Nx)),(grad4_u(Nx,u3,h,Nx)))*(2^(4/3)-1);
         ...
         L11_3(Nx-1)=filter_Boundary(u3(Nx-2,1)*u3(Nx-2,1),u3(Nx-1,1)*u3(Nx-1,1),u3(Nx,1)*u3(Nx,1))-...
            ...
            N11_3(Nx)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-1,u3,h,Nx)),(grad4_u(Nx,u3,h,Nx)),(grad4_u(1,u3,h,Nx)))*(2^(4/3)-1);
    ...
    for j=3:Nx-2
        N11_3(j)=-2*(h^(4/3))*filter_Boundary((grad4_u(j-1,u3,h,Nx)),(grad4_u(j,u3,h,Nx)),(grad4_u(j+1,u3,h,Nx)))*(2^(4/3)-1);
    ...
    dd=0;
    for j=1:Nx
        pp=pp+L11_3(j)*N11_3(j);
        dd=dd+N11_3(j)*N11_3(j);
    end
    Cw_3(s)=pp/dd; 
    Cw_3(1)=0;
    
    for j=3:Nx-2
    tau_3(j)=-2*Cw_3(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    
    for j=1
    tau_3(j)=-2*Cw_3(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1+Nx,1) +u(j-2+Nx,1) )/(12*h);   
    end
 
     for j=2
    tau_3(j)=-2*Cw_3(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2+Nx,1) )/(12*h);
     end
    
     for j=Nx-1
    tau_3(j)=-2*Cw_3(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
     
     for j=Nx
    tau_3(j)=-2*Cw_3(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1-Nx,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    ...
    for j=2
        ...
        RSG_3(j,1)=0.5* ( -tau_3(j+2)+ 8*tau_3(j+1)-8*tau_3(j-1)+ tau_3(j-2+Nx) )/(12*h);
    end
    ...
    %%% LES Modeling %%%%%
     ...
     N11_4(1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx,u4,h,Nx)),(grad4_u(1,u4,h,Nx)),(grad4_u(2,u4,h,Nx)))*(2^(4/3)-1);
        ...
        L11_4(1)=filter_Boundary(u4(Nx,1)*u4(Nx,1),u4(1,1)*u4(1,1),u4(2,1)*u4(2,1))-...
            filter_Boundary(u4(Nx,1),u4(1,1),u4(2,1))*filter_Boundary(u4(Nx,1),u4(1,1),u4(2,1));
                ...
                N11_4(2)=-2*(h^(4/3))*filter_Boundary((grad4_u(1,u4,h,Nx)),(grad4_u(2,u4,h,Nx)),(grad4_u(3,u4,h,Nx)))*(2^(4/3)-1);
    ...
    L11_4(2)=filter_Boundary(u4(1,1)*u4(1,1),u4(2,1)*u4(2,1),u4(3,1)*u4(3,1))-...
         ...
         N11_4(Nx-1)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-2,u4,h,Nx)),(grad4_u(Nx-1,u4,h,Nx)),(grad4_u(Nx,u4,h,Nx)))*(2^(4/3)-1);
         ...
         L11_4(Nx-1)=filter_Boundary(u4(Nx-2,1)*u4(Nx-2,1),u4(Nx-1,1)*u4(Nx-1,1),u4(Nx,1)*u4(Nx,1))-...
            ...
            N11_4(Nx)=-2*(h^(4/3))*filter_Boundary((grad4_u(Nx-1,u4,h,Nx)),(grad4_u(Nx,u4,h,Nx)),(grad4_u(1,u4,h,Nx)))*(2^(4/3)-1);
    ...
    for j=3:Nx-2
        N11_4(j)=-2*(h^(4/3))*filter_Boundary((grad4_u(j-1,u4,h,Nx)),(grad4_u(j,u4,h,Nx)),(grad4_u(j+1,u4,h,Nx)))*(2^(4/3)-1);
    ...
    dd=0;
    for j=1:Nx
        pp=pp+L11_4(j)*N11_4(j);
        dd=dd+N11_4(j)*N11_4(j);
    end
    Cw_4(s)=pp/dd; 
    Cw_4(1)=0;
    
    for j=3:Nx-2
    tau_4(j)=-2*Cw_4(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    
    for j=1
    tau_4(j)=-2*Cw_4(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1+Nx,1) +u(j-2+Nx,1) )/(12*h);   
    end
 
     for j=2
    tau_4(j)=-2*Cw_4(s)*(h^(4/3))*(-u(j+2,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2+Nx,1) )/(12*h);
     end
    
     for j=Nx-1
    tau_4(j)=-2*Cw_4(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
     
     for j=Nx
    tau_4(j)=-2*Cw_4(s)*(h^(4/3))*(-u(j+2-Nx,1)+  8*u(j+1-Nx,1)-8*u(j-1,1) +u(j-2,1) )/(12*h);
    end
    ...
    for j=2
        ...
        RSG_4(j,1)=0.5* ( -tau_4(j+2)+ 8*tau_4(j+1)-8*tau_4(j-1)+ tau_4(j-2+Nx) )/(12*h);
    end
...
% plot(t,Cw_4);
% xlabel('time')
% ylabel('Wong-Lilly Coefficient')
%legend('Exact ','Dynamic')
% fclose all;